...
def visualize_sinuswave_system(save_figure=False):
    ...
    trimmer = ConstVelocityDecreasingAtAttractor(const_velocity=1.0, distance_decrease=1.0)
    my_dynamics = SinusAttractorSystem(
        trimmer=trimmer, attractor_position=np.zeros(2))
