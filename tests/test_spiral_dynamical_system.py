    ...
    def test_creation(self, visualize=False):
        ...
        if visualize:
            ...
            ax.scatter(dataset_analytic[-1,0], dataset_analytic[-1,1],
                       dataset_analytic[-1,2],color='black',marker='*',label='End')
            ax.plot([SpiralDS.attractor_position[0]],
                    [SpiralDS.attractor_position[1]],
                    [SpiralDS.attractor_position[2]], 'k*')
            ...
            ax_ds.plot([SpiralDS.attractor_position[0]],
                       [SpiralDS.attractor_position[1]],
                       [SpiralDS.attractor_position[2]], 'k*')
