...
class CircularLinear(DynamicalSystem):
    ...
    def __init__(self,
                 factor_circular=1.0, factor_linear=1.0,
                 attractor_position=None,
                 orientation=None,
                 center_position=None, maximum_velocity=None, dimension=None):
        """
        Parameters
        ----------
        ...
        super().__init__(center_position=center_position, maximum_velocity=maximum_velocity,
                         dimension=dimension, attractor_position=attractor_position)
    ...
    def evaluate(self, position):
        ...
        velocity = velocity_circular*self.factor_circular + velocity_linear*self.factor_linear
